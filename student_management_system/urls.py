...
urlpatterns = [
    ...
    path('edit_staff_save/', HodViews.edit_staff_save, name='add_staff_save'),
    ...
    path('check_username_exis', HodViews.check_username_exist, name='check_username_exist'),
    ...
    path('student_all_notification', StaffViews.student_all_notification, name='student_all_notification'),
